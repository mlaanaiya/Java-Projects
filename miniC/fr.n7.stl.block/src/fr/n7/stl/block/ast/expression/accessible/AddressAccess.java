...
public class AddressAccess implements AccessibleExpression {
	...
	public Fragment getCode(TAMFactory _factory) {
		...
		Register _register = ((VariableAssignment) this.assignable).getDeclaration().getRegister();
		int _offset = ((VariableAssignment) this.assignable).getDeclaration().getOffset();
		_result.add(_factory.createLoadA(_register, _offset));
		return _result;
	}
