...
public class Conditional implements Instruction {
	...
	public boolean checkType() {
		boolean result;
		boolean _bool = this.condition.getType().compatibleWith(AtomicType.BooleanType);
		if (elseBranch == null) {
			result = _bool && this.thenBranch.checkType() ;
		} else {
			result = _bool && this.thenBranch.checkType() && this.elseBranch.checkType();
		}
		return result;
	}
