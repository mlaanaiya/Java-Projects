 ...
 * @version	1.5
 */
public class TestPolymorphismeCorrige {
	...
	public static void main(String[] args) {
		...
		qn = p1;			// Est-ce autorisé ? Pourquoi ?
			// Ceci n'est pas autorisé car p1 est déclaré comme un
			// Point alors que qn est déclarée comme un PointNomme.
			// Or Point n'est pas un sous-type de PointNomme.  C'est
			// l'inverse !
			//
			// Ici, essayer de faire un transtypage
			//
			//		qn = (PointNomme) p1;
			//
			// n'aurait pas de sens : le compilateur accepterait le
			// programme mais à l'exécution, il serait détecté que le
			// type réel de p1 n'est pas PointNomme mais Point,
			// provoquant une ClassCastException.
			//
			// Les instructions suivantes n'ont alors pas de sens
			// (poingée nulle) !
		...
		*/
		...
		qn = q;				// Est-ce autorisé ? Pourquoi ?
			// Ceci n'est pas autorisé car q est déclaré comme un
			// Point alors que qn est déclarée comme un PointNomme.
			// Or Point n'est pas un sous-type de PointNomme.
		System.out.print ("qn = "); qn.afficher(); System.out.println ();
										// Qu'est ce qui est affiché ?
		*/
		...
		qn = (PointNomme) q;		// Est-ce autorisé ? Pourquoi ?
			// Autorisé à la compilation
			// L'affectation s'exécute à l'exécution car le type réel
			// de q est bien PointNomme.
		System.out.print ("qn = "); qn.afficher(); System.out.println ();
